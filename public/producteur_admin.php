...
<section class="  max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
    <div class="text-center pb-12 bg-yelow">
    <h1 class="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-black">
            Page de modification producteurs
    </h1>
    </div>   
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6  bg-yelow">

   
 
<?php
    $recupArticle=$idcom->query('SELECT * FROM producteurs');
          ...
          <div class="w-full md:w-3/5 text-left p-6 md:p-4 space-y-2">
             <p class="text-xl text-gray-700 font-bold"><?=$article['nom'];?></p>
              <p class="text-base text-gray-400 font-normal"><?=$article['metier'];?></p>
                ...
                <a href="suppr_prod.php?id=<?= $article['id'];?>">
          <button class="p-2 pl-5 pr-5 mt-4 bg-red-500 text-gray-100 text-lg rounded-lg focus:border-4 border-blue-300">Supprimer</button>
         </a>
         <a href="modif_product.php?id=<?= $article['id'];?>">
          <button class="p-2 pl-5 pr-5 mt-4 bg-green-500 text-gray-100 text-lg rounded-lg focus:border-4 border-blue-300">Modifier</button>
         </a>
            </div>
        </div>
        <?php 
